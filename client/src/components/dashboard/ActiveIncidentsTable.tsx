...
import { FileWarning, Bot, Zap, Shield } from "lucide-react";
      ...
      <CardContent>
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center h-48 text-muted-foreground">
            <Shield className="h-12 w-12 mb-4 text-primary opacity-50" />
            <p>No active incidents threatening the organization.</p>
          </div>
        ) : (
          <Table>
            <TableHeader>
