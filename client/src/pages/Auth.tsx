...
export default function Auth() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (isLogin) {
        ...
        // Pass the selected role for signup
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left Panel - Blue Gradient Branding with Wave Pattern */}
        ...
        <div className="relative z-10 flex flex-col justify-between h-full p-12">
          ...
          <div className="max-w-md">
            ...
            <p className="text-white/80 text-base leading-relaxed">
              AI-powered Cyber Defense Platform for Public Organizations, NGOs, Education, Hospitals, and Government.
            </p>
          </div>
          ...
          <div className="flex items-center gap-3 text-white/70 text-sm">
            ...
            <span>Trusted by <span className="text-white font-medium">public organizations</span> worldwide to safeguard society</span>
          </div>
        </div>
      </div>
            ...
            {!isLogin && (
              <div className="p-3 bg-primary/5 border border-primary/20 rounded-lg">
                <p className="text-sm text-primary/80">
                  {signInMode === "alert_source" ? (
                    <>You will be able to <span className="font-medium">submit security alerts</span> to the defense team for processing.</>
                  ) : (
